...
<html>
    ...
    <head>
        <meta charset="utf-8">
        <title>Usuarios - DF PAINTBALL</title>
                ...
                <div class="col-md-9" style="width: 600px; margin-top: 20px;">
                    ...
                    <center><h2>Agendamentos</h2><br>
                        ...
                        <table class="table table-bordered" style="margin-left: 50px;">
                            ...
                            <tbody>
                                <jsp:useBean id="dao" class="com.dfpaintball.model.UsuarioDAO"/>
                                ...
                                <c:forEach items="${dao.listar()}" var="usuarios">
                                    <tr>  

                                        <td> <c:out value="${usuarios.getNome()}"></c:out> </td> 

                                            <td> <c:out value="${usuarios.getSexo()}"></c:out></td>
                                        <td> <c:out value="${usuarios.getCpf()}"/></td>
                                        <td><c:out value="${usuarios.getTelefone()}"/></td>
                                        <td>    <c:out value="${usuarios.getEmail()}"/></td>



                                        <td>
                                            <a href='tratarUsuario.jsp?action=excluir&id=<c:out value="${usuarios.getId()}"/>'>Excluir</a></td>
                                    </tr>
